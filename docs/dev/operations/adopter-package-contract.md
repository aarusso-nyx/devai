# DEVAI 1.2.7 adopter-package contract

DEVAI 1.2.7 closes the adopter boundary at the installed public package. The package is the
...
path is outside the 1.2.7 contract.
...
reconciled. For 1.2.7, this includes rerunning TEAT's governed package-only evidence recording
