...
runs one coverage node after generation and build. For the current rc.6 candidate that node
collects 106 files and 918 tests exactly once, including database, E2E, performance, and
