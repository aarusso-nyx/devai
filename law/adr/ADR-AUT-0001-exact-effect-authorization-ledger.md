...
resolves whether an action _may_ occur against a selector. Governance events
record what _did_ occur, hash-linked and append-only. Forbidden-action
...
exhaustible _before_ the effect. Conflating the record of an act with the
