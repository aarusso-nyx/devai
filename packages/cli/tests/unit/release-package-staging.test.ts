...
const SELECTED_RELEASE_VERSION = '1.4.1';
...
describe('normalized release package staging', () => {
  ...
  it('records a stable release and latest dist-tag for version 1.4.1', () => {
    ...
    expect(value.ledger).toMatchObject({
      ...
      verifier_source_commit: '4e202ca3c9aade41f3d3a0286a4e7a37a175790a',
    });
  });
