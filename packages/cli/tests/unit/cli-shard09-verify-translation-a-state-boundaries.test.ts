...
type GitFault = 'none' | 'ls-files-stderr' | 'ls-files-stdout' | 'trace-missing' | 'trace-invalid';
type StateMutation = 'none' | 'mixed';
...
beforeAll(() => {
  ...
  fixture.git(['add', '--force', '--', 'law', SOURCE_PATH, '.devai/state/a-state']);
