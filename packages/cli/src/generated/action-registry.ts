...
export const ACTION_REGISTRY = [
  {
    ...
    output_contract: {
      ...
      payload_schema: 'law/schemas/audit-observation-result.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
    ...
    authority_contract: {
      ...
      planner: {
        ...
        planner_id: 'audit-observe-bounded-plan',
        target_kinds: ['fs'],
        bounds: {
          max_batches: 128,
  ...
  },
  {
    ...
    authority: 'mesh_controller',
    description:
      'Record one schema-validated repository backlog item (finding, proposition, note, or flaky-test) under .devai/state/backlog/ through the harness boundary; round attribution is opt-in through an explicit --round and is never inferred from the session, the branch, or the active round.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/backlog-item.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
  ...
  },
  {
    ...
    authority: 'mesh_controller',
    description:
      'List repository backlog items, open by default, without network access; an explicit --round narrows the listing to items that were attributed to that round at creation and is never inferred.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/backlog-list-output.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
  ...
  },
  {
    ...
    handler: 'backlog resolve',
    path: ['backlog', 'resolve'],
    status: 'stable',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'local-write',
    authority: 'mesh_controller',
    description:
      'Mark one repository backlog item resolved with a resolution reference through the harness boundary; it never pauses, resolves, or otherwise alters a round gap, and round attribution is read from the item rather than inferred.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'backlog-resolve-bounded-plan',
        target_kinds: ['fs'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    handler: 'backlog show',
    path: ['backlog', 'show'],
    status: 'stable',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'read',
    authority: 'mesh_controller',
    description: 'Show one repository backlog item by id without network access.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
  ...
  },
  {
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'init-bind-bounded-plan',
        target_kinds: ['fs'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    authority: 'mesh_controller',
    description:
      'Build the exact segmented bootstrap plan without authorizing a mutation. With --interactive, author the plan through schema-driven prompts; the flow replays as init bind and init apply and prints the exact non-interactive argv it executed.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
  ...
  },
  {
    ...
    handler: 'release certify',
    path: ['release', 'certify'],
    status: 'stable',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'harness-write',
    ...
    output_contract: {
      ...
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/release-lifecycle-state.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
  ...
  },
  {
    ...
    handler: 'release evidence-publish',
    path: ['release', 'evidence-publish'],
    status: 'stable',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'remote-write',
    authority: 'release_controller',
    description:
      'Publish the exported evidence bundle for one exact candidate under an Owner-issued one-time authorization and a bound passing offline-verification receipt; it never publishes the product.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'release-evidence-publish-bounded-plan',
        target_kinds: ['fs', 'remote'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    handler: 'release offline-verify',
    path: ['release', 'offline-verify'],
    status: 'stable',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'read',
    authority: 'release_controller',
    description:
      'Verify an exported candidate and its evidence bundle without network access and emit a deterministic offline-verification receipt; it persists no state and grants no lifecycle transition or publication authority.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/release-offline-verification-receipt.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
  ...
  },
  {
    ...
    authority: 'release_controller',
    description:
      'Resolve the release lifecycle plan for one exact candidate from canonical inputs and emit a deterministic plan receipt; it persists no state or evidence.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
  ...
  },
  {
    ...
    authority: 'release_controller',
    description:
      'Record the Inspector preflight_passed state that opens the release lifecycle for one exact candidate against a bound valid plan receipt; it grants no packaging or publication authority.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
  ...
  },
  {
    ...
    authority: 'release_controller',
    description:
      'Dispatch the product publication for one exact candidate under a separate Owner-issued one-time authorization and record publication_dispatched; published evidence never authorizes it and a dispatch is never published.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'release-publish-bounded-plan',
        target_kinds: ['fs', 'remote'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    authority: 'release_controller',
    description:
      'Report the exact recorded lifecycle head for one candidate and the states verifiable from supplied or located receipts, including published from a verified signed publication receipt; the observation advances, repairs, and revives nothing.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/release-lifecycle-observation.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
  ...
  },
  {
    ...
    handler: 'round tracking disable',
    path: ['round', 'tracking', 'disable'],
    status: 'preview',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'remote-write',
    authority: 'mesh_controller',
    ...
    output_contract: {
      ...
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/governance-projection-status.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'round-tracking-disable-bounded-plan',
        target_kinds: ['fs', 'remote'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    handler: 'round tracking enable',
    path: ['round', 'tracking', 'enable'],
    status: 'preview',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'remote-write',
    authority: 'mesh_controller',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'round-tracking-enable-bounded-plan',
        target_kinds: ['fs', 'remote'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    handler: 'round tracking status',
    path: ['round', 'tracking', 'status'],
    status: 'preview',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'read',
    authority: 'mesh_controller',
  ...
  },
  {
    ...
    handler: 'round tracking sync',
    path: ['round', 'tracking', 'sync'],
    status: 'preview',
    profiles: ['tier1', 'tier2', 'tier3'],
    effect: 'remote-write',
    authority: 'mesh_controller',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'round-tracking-sync-bounded-plan',
        target_kinds: ['fs', 'remote'],
        bounds: {
          max_batches: 128,
          max_targets_per_batch: 64,
  ...
  },
  {
    ...
    authority: 'mesh_controller',
    description:
      'Deterministically classify one SensorReading and record its route; inconclusive always escalates to a human.',
    output_contract: {
      schemaVersion: '1.0.0',
      mode: 'action-envelope',
      envelope_schema: 'law/schemas/action-result.schema.json',
      success_channel: 'stdout',
      payload_schema: 'law/schemas/triage-classify-result.schema.json',
    },
    error_contract: {
      schemaVersion: '1.0.0',
      mode: 'structured-error-envelope',
    ...
    authority_contract: {
      ...
      planner: {
        kind: 'bounded-batches',
        planner_id: 'triage-classify-bounded-plan',
        target_kinds: ['fs'],
        bounds: {
          max_batches: 8,
          max_targets_per_batch: 16,
          max_total_targets: 128,
        },
        recovery: 'preserve-and-report',
      },
      boundary: {
